...
list(APPEND _cmake_import_check_files_for_openpose_3d "${_IMPORT_PREFIX}/lib/libopenpose_3d.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_calibration "${_IMPORT_PREFIX}/lib/libopenpose_calibration.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_core "${_IMPORT_PREFIX}/lib/libopenpose_core.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_face "${_IMPORT_PREFIX}/lib/libopenpose_face.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_filestream "${_IMPORT_PREFIX}/lib/libopenpose_filestream.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_gpu "${_IMPORT_PREFIX}/lib/libopenpose_gpu.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_gui "${_IMPORT_PREFIX}/lib/libopenpose_gui.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_hand "${_IMPORT_PREFIX}/lib/libopenpose_hand.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_net "${_IMPORT_PREFIX}/lib/libopenpose_net.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_pose "${_IMPORT_PREFIX}/lib/libopenpose_pose.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_producer "${_IMPORT_PREFIX}/lib/libopenpose_producer.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_thread "${_IMPORT_PREFIX}/lib/libopenpose_thread.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_tracking "${_IMPORT_PREFIX}/lib/libopenpose_tracking.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_unity "${_IMPORT_PREFIX}/lib/libopenpose_unity.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_utilities "${_IMPORT_PREFIX}/lib/libopenpose_utilities.dylib" )
...
list(APPEND _cmake_import_check_files_for_openpose_wrapper "${_IMPORT_PREFIX}/lib/libopenpose_wrapper.dylib" )
...
set_target_properties(openpose PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libopenpose.1.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenpose.1.7.0.dylib"
  )

list(APPEND _cmake_import_check_targets openpose )
list(APPEND _cmake_import_check_files_for_openpose "${_IMPORT_PREFIX}/lib/libopenpose.1.7.0.dylib" )
